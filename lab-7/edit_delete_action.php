...
else if($params['action']=='edit')
{
  ...
  ?>
  <div class="mt-3 show toast align-items-center text-white bg-<?php echo $_SESSION['edit_status']; ?> border-0" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="d-flex">
          ...
          <div class="edit-form shadow ">
            <form method="POST" action="edit_product.php">
              ...
              <div class="mb-3">
                ...
                <textarea type="password" class="form-control" name="product_description" rows="3"><?php echo $product_description; ?></textarea>
