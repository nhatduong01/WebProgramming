...
<body class="loginPage">
  <nav class="navbar navbar-light bg-light" style="">
    <form class="container-fluid justify-content-end" method="POST" action="add_product.php">
        ...
        <a href="authentication/logout.php" class="btn btn-outline-danger me-2">Log out</a>
    </form>
  </nav>
  <?php if(isset($_SESSION['adding_status'])) {?>
    ...
    <div class="toast align-items-center show toastMessage bg-<?php echo $_SESSION['edit_status'];?> mt-3" role="alert" aria-live="assertive" aria-atomic="true" id="toastMessage">
      <div class="d-flex">
        <div class="toast-body">
        <?php
          echo $_SESSION['message'];
